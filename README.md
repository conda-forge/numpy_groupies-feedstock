...
Home: https://pypi.org/project/numpy-groupies/
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/numpy_groupies-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/numpy_groupies-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add numpy_groupies
# for installing globally
pixi global install numpy_groupies
```
...
It is possible to list all of the versions of `numpy_groupies` available on your platform:
...
```
pixi search numpy_groupies --channel conda-forge
```
